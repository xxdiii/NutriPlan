...
import { getTodayCompliance, getWeeklyCompliance, calculateCombinedStreak } from '../../services/complianceService';
  ...
  return (
    <div className={`p-6 rounded-2xl shadow-lg ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white'
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className={`flex items-center space-x-1 px-3 py-1 rounded-full ${isDark ? 'bg-emerald-900/30 text-emerald-400' : 'bg-emerald-100 text-emerald-700'
          }`}>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className={`text-sm font-bold ${todayComplianceRate >= 75
            ? 'text-emerald-600'
        ...
        <div className={`h-2 rounded-full ${isDark ? 'bg-gray-700' : 'bg-gray-200'}`}>
          <div
            className={`h-2 rounded-full transition-all duration-500 ${todayComplianceRate >= 75
              ? 'bg-emerald-600'
              : todayComplianceRate >= 50
                ? 'bg-yellow-600'
                : 'bg-red-600'
      ...
      <div className={`p-3 rounded-xl ${isDark ? 'bg-gray-700/50' : 'bg-gray-50'
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <span className={`text-sm font-bold ${weeklyStats.overallCompliance >= 75
            ? 'text-emerald-600'
        ...
        <div className="grid grid-cols-3 gap-2 text-xs">
          <div className={`text-center p-2 rounded ${isDark ? 'bg-emerald-900/20 text-emerald-400' : 'bg-emerald-50 text-emerald-700'
            }`}>
          ...
          <div className={`text-center p-2 rounded ${isDark ? 'bg-red-900/20 text-red-400' : 'bg-red-50 text-red-700'
            }`}>
          ...
          <div className={`text-center p-2 rounded ${isDark ? 'bg-gray-600 text-gray-300' : 'bg-gray-100 text-gray-700'
            }`}>
