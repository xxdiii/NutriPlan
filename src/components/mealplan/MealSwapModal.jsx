...
import { X, RefreshCw, Flame, Target, TrendingUp, Clock, ChefHat } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className={`relative w-full max-w-5xl rounded-3xl shadow-2xl transition-all ${
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      {meal.__constraints?.warnings?.length > 0 && (
                        <div className={`mb-3 text-xs p-2 rounded-lg ${
                          isDark ? 'bg-yellow-900/20 text-yellow-300 border border-yellow-800' : 'bg-yellow-50 text-yellow-800 border border-yellow-200'
                        }`}>
                      ...
                      {/* Swap Button */}
                      <button className={`w-full px-3 py-2 rounded-lg font-medium flex items-center justify-center space-x-2 transition-all ${
                        isDark 
